// ============================================================================
// Character data. The actual data lives in `characters.json` (a plain
...
export const CHARACTERS: Record<string, CharacterDefinition> = charactersJson as Record<string, CharacterDefinition>;
